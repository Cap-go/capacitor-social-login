...
function SupabaseCreateAccountPage() {
  ...
  const handleCreateAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatusMessage(`Account created successfully! ${data.user ? `Signed in as ${data.user.email}` : 'Please check your email to verify your account.'}`);
      setEmail('');
      setPassword('');
      setConfirmPassword('');
      
      // Navigate to dashboard after successful account creation if user is immediately signed in
      if (data.user) {
        setTimeout(() => {
      ...
      <div className="app-card">
        ...
        <form onSubmit={handleCreateAccount} className="firebase-form">
          ...
          <p className="create-account-text">
            Already have an account? <button type="button" className="create-account-link" onClick={() => navigate('/supabase')} disabled={isLoading || isSocialLoading !== null}>Sign in</button>
          </p>
        </form>
      </div>
    </div>
...
export default SupabaseCreateAccountPage;
