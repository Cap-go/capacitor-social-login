...
//            )
            ...
            if let _ = fullName?.givenName {
                sendRequest(code: authorizationCode, identityToken: identityToken, email: email ?? "", completion: errorCompletion, skipUser: false)
            } else {
                sendRequest(code: authorizationCode, identityToken: identityToken, email: email ?? "", completion: errorCompletion, skipUser: true)
            }
    ...
    func sendRequest(code: String, identityToken: String, email: String, completion: @escaping ((Result<AppleProviderResponse, AppleProviderError>) -> Void), skipUser: Bool) {
