...
//        this.clientId = "1038081411966-63r6lsm5og90o5t04hl5i0loopqt7m47.apps.googleusercontent.com"; now we use the web one WTF
        this.clientId = "1038081411966-8q4qgeam3d4itku0r43qkginl9cljc5a.apps.googleusercontent.com";
    }


    @Override
    public FutureFunctionResult<JSONObject, String> login(PluginHelpers helpers, JSONObject config) {
        FutureFunctionResult<JSONObject, String> loginResult = new FutureFunctionResult<>();
            ...
            new CredentialManagerCallback<GetCredentialResponse, GetCredentialException>() {
                ...
                public void onResult(GetCredentialResponse result) {
                    try {
                        ...
                        loginResult.resolveError("Error creating success response: " + e.getMessage());
                    }
                }
                ...
                public void onError(GetCredentialException e) {
                    ...
                    try {
                        ...
                        loginResult.resolveError("Error creating error response: " + jsonException.getMessage());
                    }
                }
            }
        );
    ...
    private JSONObject handleSignInResult(GetCredentialResponse result) throws JSONException {
