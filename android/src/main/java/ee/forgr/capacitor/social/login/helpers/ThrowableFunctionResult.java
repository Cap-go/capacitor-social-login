...
public class ThrowableFunctionResult<SUCCESS>
  extends FunctionResult<SUCCESS, Throwable> {
  ...
  public <NEW_SUCCESS> ThrowableFunctionResult<NEW_SUCCESS> transformSuccess(
    ThrowingConsumer<SUCCESS, NEW_SUCCESS> transform
  ) {
