...
public class DependencyAvailabilityChecker {
    ...
    private static boolean isGoogleAvailable() {
        ...
        if (!allAvailable) {
            Log.w(LOG_TAG, "Google Sign-In dependencies are not available. " +
    ...
    private static boolean isFacebookAvailable() {
        ...
        if (!allAvailable) {
            Log.w(LOG_TAG, "Facebook SDK dependencies are not available. " +
    ...
    private static boolean isAppleAvailable() {
        ...
        if (!allAvailable) {
            Log.w(LOG_TAG, "Apple Sign-In dependencies are not available. " +
    ...
    private static boolean isTwitterAvailable() {
        ...
        if (!allAvailable) {
            Log.w(LOG_TAG, "Twitter OAuth dependencies are not available. " +
                  "Ensure OkHttp dependencies are included in your app's build.gradle");
        }
