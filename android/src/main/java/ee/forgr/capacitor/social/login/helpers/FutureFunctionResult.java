...
public class FutureFunctionResult<SUCCESS, ERROR>
  extends FunctionResult<SUCCESS, ERROR> {
  ...
  public static <SUCCESS, ERROR> FutureFunctionResult<SUCCESS, ERROR> success(
    SUCCESS success
  ) {
    return new FutureFunctionResult<>(success, null);
  }

  public static <SUCCESS, ERROR> FutureFunctionResult<SUCCESS, ERROR> error(
    ERROR error
  ) {
